...
addChild("contactLimitSwitch",contactLimitSwitch);
    ...
    public void periodic() {
       ...
       if (mCountUp++ > 40){
            writeSensorColor();
            SmartDashboard.putString("color", getSensorColor());
            mCountUp = 0;
       }
    }
    ...
    private void writeSensorColor() {
         double detectedColor[] = readColor();

        SmartDashboard.putNumber("red", detectedColor[0]);
        SmartDashboard.putNumber("green", detectedColor[1]);
        SmartDashboard.putNumber("blue", detectedColor[2]);
    }
