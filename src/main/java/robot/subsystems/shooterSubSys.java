...
public class shooterSubSys extends Subsystem {
    ...
    private double previousFlywheel_P, previousFlywheel_I, previousFlywheel_D, previousFlywheel_Iz;
    private double previousFlywheel_FF, previousFlywheelMinOutput, previousFlywheelMaxOutput;
...
turretMotor.setInverted(false);
    ...
    public void setFlywheelPower(double power) {
        flywheelPower = power;
        try { flywheelLeftMotor.set(flywheelPower); }
        catch (Exception e) {     }// nothing to do

        try { flywheelRightMotor.set(flywheelPower); }
        catch (Exception e) {     }// nothing to do
    }
    ...
    public void stopFlywheel() {
        ...
        //updateFlywheelSetPoint(0);                            // this is for pid use
    }

    public double getFlywheelRPM() {
        try {                 return flywheelEncoder.getVelocity();}   
        catch (Exception e) { return 0; }
    }

    public double getFlywheelEncoder() {
        try { return flywheelEncoder.getPosition(); }
        catch (Exception e) { return 0; }
    }

    private void initFlywheelCtlr(){
        try {     
            flywheelLeftMotor = new CANSparkMax(FLYWHEEL_LEFT_CAN_ID, MotorType.kBrushless);
            flywheelLeftMotor.restoreFactoryDefaults();
        } catch (Exception e) {
            System.out.println("********** Spark MAX LEFT motor not found in ShooterSubSys *********");       
        }
        ...
        try { 
            ...
            System.out.println("********** Spark MAX RIGHT motor not found in ShooterSubSys *********");       
        }
    }
    ...
    private void initFlywheelPid(){
        try {
            ...
            //flywheelLeftPidController.setReference(0, ControlType.kVelocity);         // set set point to 0
