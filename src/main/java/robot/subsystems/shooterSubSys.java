...
public class shooterSubSys extends Subsystem {
    ...
    public final double HIGH_GOAL_SPEED = 9050.0;
    public final double LOW_GOAL_SPEED = 5000.0;
    public final double PID_FIRE_DELTA = 150.0;     // The range +- OK to Fire
    ...
    //
    public static final double HOOD_EXTENDED_MAX = 4.8;    // measured 4.85 
    public static final double HOOD_RETRACTED_MIN = 0.005;    // measured 0.005
...
rotateEncoder.setPIDSourceType(PIDSourceType.kRate);
    ...
    public double getRotateAngle(){
        ...
        return getRotateEncoderValue() / 1.4222222 ;
    }
