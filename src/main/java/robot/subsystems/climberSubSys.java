...
private SpeedControllerGroup climbMotorGroup;
    ...
    public static enum ClimberSmardashState {UPDATE, NOUPDATE};
    public static ClimberSmardashState climberSmardashState = ClimberSmardashState.NOUPDATE;
...
addChild("ClimbMotorGroup",climbMotorGroup);
    ...
    //System.out.println("climbPotTopValue = " + climbPotTopValue + "  CLIMBPOTRANGEVALUE=" + CLIMBPOTRANGEVALUE + "    climbPotbottomValue=" + climbPotbottomValue);  
    ...
    public void periodic() {
        ...
        if (climberSmardashState == ClimberSmardashState.UPDATE) updateSmartDashboard();
    }
    ...
    public void setSmartdashUpdatesOn(){
        climberSmardashState = ClimberSmardashState.UPDATE;
    }
    public void setSmartdashUpdatesOf(){
        climberSmardashState = ClimberSmardashState.NOUPDATE;
    }
    ...
    public void climbMotorSetAtSpeed(double speed, boolean overrideFlag) {
        if(overrideFlag) {
            ...
            climbWinchMotor1.set(currentPowerValue * 1.0);
            return;    
        }
        ...
        if (speed > 0) {
            ...
            System.out.println("Raising climber   CurrPot=" + climbPotCurrentValue + "  TopLimit=" + climbPotTopValue);
            if (climbPotCurrentValue < climbPotTopValue) {
                // were Not at the top so continue raising at 1/2 power because there is no weight to climber
                climbWinchMotor1.set((speed / 2) * 1.0);     // Inver speed because of wiring of motor
            ...
            if (climbPotCurrentValue >= climbPotbottomValue) {  
                ...
                climbWinchMotor1.set(speed * 1.0);
                currentPowerValue = speed;            
                return;            
            } else {
