...
private Solenoid gearShiftValve;
    ...
    public static enum DriverSmardashState {UPDATE, NOUPDATE};
    public static DriverSmardashState driverSmardashState = DriverSmardashState.NOUPDATE;
...
leftFMtr = new WPI_TalonSRX(1);


        
leftRMtr = new WPI_TalonSRX(2);


        
leftTMtr = new WPI_TalonSRX(3);
...
rightFMtr = new WPI_TalonSRX(7);


        
rightRMtr = new WPI_TalonSRX(8);


        
rightTMtr = new WPI_TalonSRX(9);
...
gearShiftValve = new Solenoid(0, 0);
addChild("gearShiftValve",gearShiftValve);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //posnTracker = new PositionTracker(this, WHEELBASE,  Field_Position_Startup_X, Field_Position_Startup_Y, Field_Position_Startup_O);
    ...
    void initVar() {
        ...
        // posnTracker.init(Field_Position_Startup_X, Field_Position_Startup_Y, Field_Position_Startup_O);
        avgVelMinus1 = 0;
        avgVelMinus2 = 0;
        avgVelMinus3 = 0;
    }
    ...
    public void periodic() {
        ...
        if(driverSmardashState == DriverSmardashState.UPDATE) updateSmartDashboard();
    ...
    public void setSmartdashUpdatesOn(){
        driverSmardashState = DriverSmardashState.UPDATE;
    }
    public void setSmartdashUpdatesOf(){
        driverSmardashState = DriverSmardashState.NOUPDATE;
    }
