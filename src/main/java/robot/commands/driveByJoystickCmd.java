...
public class driveByJoystickCmd extends Command {
    ...
    private static final int PLAY_REV_AXIS = 2;
    private static final int PLAY_FWD_AXIS = 3;

    private static final int PLAY_LEFT_TWIST_AXIS = 0;    
    private static final int PLAY_RIGHT_TWIST_AXIS = 4;
    
    private static final int PLAY_LEFT_LOW_GEAR_BTN = 9;
