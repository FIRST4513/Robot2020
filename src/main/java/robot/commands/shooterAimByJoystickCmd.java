...
public class shooterAimByJoystickCmd extends Command {
    ...
    protected void execute() {
        ...
        boolean joyTrigger = Robot.oi.getcoDriverJoystick().getTrigger();
        ...
        if(joyTrigger == true) {
            ...
            if(Robot.shooterSubSys.checkHoodLimitSwitches() == HoodSwitchPressed.NEITHER) {
                Robot.shooterSubSys.moveTurret((joyY * ((joyThrottle + 1)/2)));
            }
    ...
    protected boolean isFinished() {
        if(Robot.oi.getcoDriverJoystick().getTrigger() == false) {
            return true;
        } else {
            return false;
        }
