...
public class shooterAimByVisionCmd extends Command {
    ...
    protected void execute() {
        ...
        targetDistance = Robot.udpSubSys.getVisionTargetDistance();
        ...
        if (targetY >= Math.abs(TARGET_Y_DEADBAND)) {
            if (targetDistance >= 20) { Robot.shooterSubSys.moveHood(0.7); }
            else if (targetDistance >= 10) { Robot.shooterSubSys.moveHood(0.5); }
            else if (targetDistance >= 5) { Robot.shooterSubSys.moveHood(0.4); }
            else if (targetDistance >= 2.5) { Robot.shooterSubSys.moveHood(0.3); }
        }
    }
