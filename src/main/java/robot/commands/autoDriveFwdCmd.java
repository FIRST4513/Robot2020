...
public class autoDriveFwdCmd extends Command {
    ...
    public autoDriveFwdCmd(double dist, double speed, double heading, double timeout) {
    ...
    protected void initialize() {
        ...
        //}
        Robot.drivetrain.resetEncodersAndStats();   // zero all out
		Robot.drivetrain.driveStraightToHdg(m_speed, currYaw, false) ;
    }
    ...
    protected void execute() {
        ...
        if (state == 1) {
            ...
            if (Math.abs(Robot.drivetrain.getAverageDist()) >= m_dist) {
                // weve completed our trip
                state = 3;
                return;
            }
    	}
