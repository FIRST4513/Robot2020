...
public JoystickButton colorWheelLowerBtn;
...
colorWheelLowerBtn = new JoystickButton(coDriverJoystick, 3);
colorWheelLowerBtn.whileHeld(new colorWheelLowerCmd());
colorWheelRaiseBtn = new JoystickButton(coDriverJoystick, 5);
colorWheelRaiseBtn.whenPressed(new colorWheelRaiseCmd());
colorWheelRotateColorBtn = new JoystickButton(coDriverJoystick, 4);
colorWheelRotateColorBtn.whenPressed(new RotateToColorCmd());
colorWheelThreeRotateBtn = new JoystickButton(coDriverJoystick, 6);
colorWheelThreeRotateBtn.whenPressed(new rotateThreeTimeCmd());
...
driverJoystck = new Joystick(0);
        ...
        SmartDashboard.putData("rotateThreeTimeCmd", new rotateThreeTimeCmd());
        ...
        SmartDashboard.putData("RotateToColorCmd", new RotateToColorCmd());
